...
def downgrade() -> None:
    ...
    op.execute("DELETE FROM inventory_movements WHERE id = 'a0000001-0000-0000-0000-000000000021'")
    op.execute("DELETE FROM inventory WHERE id = 'a0000001-0000-0000-0000-000000000020'")
    op.execute("DELETE FROM product_variants WHERE id = 'f0000001-0000-0000-0000-000000000001'")
    op.execute("DELETE FROM products WHERE id = 'b0000001-0000-0000-0000-000000000001'")
