"""Seed data - initial dataset for FashionVision AI
    ...
    op.execute("""
        INSERT INTO product_variants (id, product_id, size_attribute_id, color_attribute_id, color_hex, sku_variant, price_modifier, is_active) VALUES
            ('f0000001-0000-0000-0000-000000000001',
             ...
             0,
             TRUE),
            ('d317341d-b306-46ca-b18a-1e56a6eb252c',
             'b0000001-0000-0000-0000-000000000001',
             'e0000001-0000-0000-0000-000000000020',
             ...
             0,
             TRUE),
            ('a3d7f491-82a8-4db6-a4c0-5396e5cbd0ba',
             '41ce8430-152b-49b4-a08b-2da0db2df072',
             'e0000001-0000-0000-0000-000000000020',
             'e0000001-0000-0000-0000-000000000016',
             '#ff0000',
             ...
             0,
             TRUE),
            ('74be3456-50c2-41be-b8ae-307c579b7648',
             '41ce8430-152b-49b4-a08b-2da0db2df072',
             'e0000001-0000-0000-0000-000000000020',
             ...
             0,
             TRUE),
            ('7aef4af3-5903-4185-8e54-8ec397f98fdc',
             '41ce8430-152b-49b4-a08b-2da0db2df072',
             'e0000001-0000-0000-0000-000000000020',
             ...
             0,
             TRUE),
            ('2b6f88c4-2bac-4505-bb29-d15799c8b654',
             '6f718ca2-d7e5-4a88-95f6-cdc173a0bbac',
             'e0000001-0000-0000-0000-000000000001',
             'e0000001-0000-0000-0000-000000000012',
             '#1f4bff',
             'PAN-MEZ-CAR-001-CHI-AZM',
             0,
             TRUE),
            ('60bf83c8-1a7c-4a2c-9d0e-1e9b103e3e5d',
             'dcf76b48-4b03-456a-87ed-373d3a4d2189',
             'e0000001-0000-0000-0000-000000000002',
             'e0000001-0000-0000-0000-000000000017',
             '#05acff',
             'PAN-MEZ-OVE-01-CHI-AZU',
             0,
             TRUE)
        ON CONFLICT DO NOTHING
    """)
    ...
    op.execute("""
        INSERT INTO inventory (id, product_variant_id, quantity_available, quantity_reserved, low_stock_threshold, stock_status, warehouse_location, updated_by) VALUES
            ('a0000001-0000-0000-0000-000000000020',
             'f0000001-0000-0000-0000-000000000001',
             5, 0, 5, 'available', 'A-01-03',
             'a0000001-0000-0000-0000-000000000001'),
            ('adb90ee5-2cfb-4008-8740-665b1c3df5bc',
             'd317341d-b306-46ca-b18a-1e56a6eb252c',
             13, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001'),
            ('a3a60e75-ac3b-4e83-8aca-3bbac211d1cb',
             'a3d7f491-82a8-4db6-a4c0-5396e5cbd0ba',
             10, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001'),
            ('2c57a0a1-4a3a-4512-9feb-ea5ae5f7eefb',
             '74be3456-50c2-41be-b8ae-307c579b7648',
             10, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001'),
            ('a421ab48-2e53-4ad2-8127-5ab61e42641f',
             '7aef4af3-5903-4185-8e54-8ec397f98fdc',
             10, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001'),
            ('ad9d90e0-9e8f-4558-877e-6e0a7e93f2e6',
             '2b6f88c4-2bac-4505-bb29-d15799c8b654',
             10, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001'),
            ('f456d2d5-6e85-4e68-b0db-76f51c9e4274',
             '60bf83c8-1a7c-4a2c-9d0e-1e9b103e3e5d',
             10, 0, 5, 'available', NULL,
             'a0000001-0000-0000-0000-000000000001')
        ON CONFLICT DO NOTHING
    ...
    op.execute("""
        INSERT INTO inventory_movements (id, product_variant_id, movement_type, quantity_change, quantity_before, quantity_after, notes, created_by) VALUES
            ('a0000001-0000-0000-0000-000000000021',
             ...
             'a0000001-0000-0000-0000-000000000001'),
            ('7d43f0e7-3dec-4ae2-8e7e-b96af857fca8',
             'd317341d-b306-46ca-b18a-1e56a6eb252c',
             'restock', 13, 0, 13,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001'),
            ('f25f8e0b-14b6-4c2a-9af7-9cce13440eeb',
             'a3d7f491-82a8-4db6-a4c0-5396e5cbd0ba',
             'restock', 10, 0, 10,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001'),
            ('15aff7e7-3d5d-4d1b-8fee-5b7a9e5f45b3',
             '74be3456-50c2-41be-b8ae-307c579b7648',
             'restock', 10, 0, 10,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001'),
            ('a67a2f40-5e78-4d00-a4b6-c5fcd1b45006',
             '7aef4af3-5903-4185-8e54-8ec397f98fdc',
             'restock', 10, 0, 10,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001'),
            ('4d5fe43f-4011-460a-9669-7974df3f94ed',
             '2b6f88c4-2bac-4505-bb29-d15799c8b654',
             'restock', 10, 0, 10,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001'),
            ('811ad231-ded4-4eeb-8864-6206f9f1c196',
             '60bf83c8-1a7c-4a2c-9d0e-1e9b103e3e5d',
             'restock', 10, 0, 10,
             'Stock inicial',
             'a0000001-0000-0000-0000-000000000001')
...
def downgrade() -> None:
    op.execute("DELETE FROM inventory_movements WHERE id IN ('a0000001-0000-0000-0000-000000000021', '7d43f0e7-3dec-4ae2-8e7e-b96af857fca8', 'f25f8e0b-14b6-4c2a-9af7-9cce13440eeb', '15aff7e7-3d5d-4d1b-8fee-5b7a9e5f45b3', 'a67a2f40-5e78-4d00-a4b6-c5fcd1b45006', '4d5fe43f-4011-460a-9669-7974df3f94ed', '811ad231-ded4-4eeb-8864-6206f9f1c196')")
    op.execute("DELETE FROM inventory WHERE id IN ('a0000001-0000-0000-0000-000000000020', 'adb90ee5-2cfb-4008-8740-665b1c3df5bc', 'a3a60e75-ac3b-4e83-8aca-3bbac211d1cb', '2c57a0a1-4a3a-4512-9feb-ea5ae5f7eefb', 'a421ab48-2e53-4ad2-8127-5ab61e42641f', 'ad9d90e0-9e8f-4558-877e-6e0a7e93f2e6', 'f456d2d5-6e85-4e68-b0db-76f51c9e4274')")
    op.execute("DELETE FROM product_variants WHERE id IN ('f0000001-0000-0000-0000-000000000001', 'd317341d-b306-46ca-b18a-1e56a6eb252c', 'a3d7f491-82a8-4db6-a4c0-5396e5cbd0ba', '74be3456-50c2-41be-b8ae-307c579b7648', '7aef4af3-5903-4185-8e54-8ec397f98fdc', '2b6f88c4-2bac-4505-bb29-d15799c8b654', '60bf83c8-1a7c-4a2c-9d0e-1e9b103e3e5d')")
    op.execute("DELETE FROM products WHERE id IN ('b0000001-0000-0000-0000-000000000001', '41ce8430-152b-49b4-a08b-2da0db2df072', '6f718ca2-d7e5-4a88-95f6-cdc173a0bbac', 'dcf76b48-4b03-456a-87ed-373d3a4d2189')")
    op.execute("DELETE FROM attribute_options WHERE id IN ('e0000001-0000-0000-0000-000000000001', 'e0000001-0000-0000-0000-000000000002', 'e0000001-0000-0000-0000-000000000003', 'e0000001-0000-0000-0000-000000000004', 'e0000001-0000-0000-0000-000000000005', 'e0000001-0000-0000-0000-000000000006', 'e0000001-0000-0000-0000-000000000020', 'e0000001-0000-0000-0000-000000000012', 'e0000001-0000-0000-0000-000000000013', 'e0000001-0000-0000-0000-000000000014', 'e0000001-0000-0000-0000-000000000015', 'e0000001-0000-0000-0000-000000000016', 'e0000001-0000-0000-0000-000000000017', 'e0000001-0000-0000-0000-000000000018')")
    op.execute("DELETE FROM categories WHERE id IN ('c0000001-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000002', 'c0000001-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000004', 'c0000001-0000-0000-0000-000000000005')")
    op.execute("DELETE FROM suppliers WHERE id IN ('d0000001-0000-0000-0000-000000000001', 'd0000001-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000003')")
    op.execute("DELETE FROM users WHERE id IN ('a0000001-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000002', 'a0000001-0000-0000-0000-000000000003')")
